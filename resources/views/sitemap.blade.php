...
<body >
	...
	<ul class="index_nav nav navbar-nav" id="menu">
		...
		<div class="row padding_x_10" style="margin-bottom: 20px">
			<h1 style="font-size: 32px;">{{$data[0]->name}}</h1>
		</div>



		<div class="row padding_x_10" style="margin-bottom: 80px">
			<div class="row border_top border_bottom intro-row" style="font-size: 16px;"> 
				<?php echo $data[0]->text_data;?>
				...
				<div class="row padding_x_10" style="margin-top:200px;margin-bottom: 20px;padding: 0 20%">
